        ...
        <div className="container text-center dias">
          ...
          <div className="form-check form-check-inline justify-content-center">
            <input
              ...
              value="option1"
            />
            <label className="form-check-label m-1 mb-3" for="inlineCheckbox1">
              Semana
            </label>
          </div>
        ...
        <div className="container text-center">
          ...
          <div className="form-check form-check-inline">
            <input
              ...
              value="option2"
            />
            <label className="form-check-label m-1 mb-3" for="inlineCheckbox2">
              Tarde
            </label>
          </div>
          <div className="form-check form-check-inline">
            <input
              ...
              value="option3"
            />
            <label className="form-check-label m-1 mb-3" for="inlineCheckbox3">
              Noche
            </label>
          </div>
        </div>
